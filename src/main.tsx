...
const recordSource = new RecordSource((window as unknown as InjectedWindow).__RECORD_SOURCE)
const environment = createEnvironment("http://localhost:8082/graphql", recordSource)
